...
//end of control box 
		...
		<div class="sda-form-area">
		    <div class="sda-form-input-box">
			    <form method="post" action="<?php if($whmcs_bridge_enabled==1){ echo esc_url(void_ewhmcse_whmcs_bridge_url() .'?ccce=domainchecker'); } else{ echo esc_url($settings['whmcs_url'].'/domainchecker.php'); }  ?>" >
			        <input class="iddomainname" type="text" autocomplete="off" required name="domain" placeholder="<?php echo esc_html($settings['search_bar_placeholder']); ?>">
			        <input id="find" type="submit" value="<?php echo esc_html($settings['search_button_text']); ?>">
			   	</form>
		    </div>
	...
	<?php else: ?>
		<div class="sda-form-area">
			<form method="post" action="<?php if($whmcs_bridge_enabled==1){ echo esc_url(void_ewhmcse_whmcs_bridge_url() .'?ccce=domainchecker'); } else{ echo esc_url($settings['whmcs_url'].'/domainchecker.php'); }  ?>">
			    <div class="sda-form-input-box">
			        <input type="text" autocomplete="off" required name="domain" placeholder="<?php echo esc_html($settings['search_bar_placeholder']); ?>">
			        <input type="submit" value="<?php echo esc_html($settings['search_button_text']); ?>">
			    </div>
			</form>
        </div>
	<?php endif; ?>
